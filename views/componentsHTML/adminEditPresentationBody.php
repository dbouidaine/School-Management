<div class="wrapper">
    ...
    <div class="content p-5">
        ...
        <div class="card text-left">
          ...
          <div class="card-body">
            <form class="new-article" action="<?=url('presentation/update')?>" method="POST" enctype="multipart/form-data">
              ...
              <input class="w-100 file-input" name="image" type="file" accept="image/*">
